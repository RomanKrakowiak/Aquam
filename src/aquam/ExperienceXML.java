...
public class ExperienceXML {
   ...
   /**
    * The main equivalent of ExperienceXML. It loads and parses the xml file. Then it gets the racine Element and call the next function
    */
...
/**
 * 
 * Could be an useful function later. It is a recurssive function for exploring the xml file 
 ...
 * @return The first row element, it is only useful if all the parameters name are in the first row (and the values in the others) 
 */
...
/**
 * 
 * This function give the final String to put in postgreSQL to insert an experience Datas. It uses insertEtape for each etape
 * @param source Have to be the racine of the xml file
 */
...
/**
 * 
 * @param dataTraveler which is an iterator of Cells in a Row. Each Cell contain a Data to put in the "values" String
 * @return a String which is an iteration of "Insert into(parameters)values(values);" of the .xml doc
 */
